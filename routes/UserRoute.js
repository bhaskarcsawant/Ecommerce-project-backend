...
const { registerUser, getAllUsers, loginUser, logoutUser, forgotPassword, resetPassword, getUserDetails, updatePassword, updateProfile, getUserDetailsAdmin } = require("../controllers/UserController");
...
router.route('/user/:id').get(isUserAdmin, getUserDetailsAdmin)
